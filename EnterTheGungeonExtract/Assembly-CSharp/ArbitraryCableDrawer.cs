...
{
	// Token: 0x06006948 RID: 26952 RVA: 0x00292F5C File Offset: 0x0029115C
	...
	// Token: 0x06006949 RID: 26953 RVA: 0x00293080 File Offset: 0x00291280
	private void LateUpdate()
	{
		if (this.Attach1 && this.Attach2)
		{
			Vector3 vector = this.Attach1.position.XY().ToVector3ZisY(-3f) + this.Attach1Offset.ToVector3ZisY(0f);
			Vector3 vector2 = this.Attach2.position.XY().ToVector3ZisY(-3f) + this.Attach2Offset.ToVector3ZisY(0f);
			this.BuildMeshAlongCurve(vector, vector, vector2 + new Vector3(0f, -2f, -2f), vector2, 0.03125f);
			this.m_mesh.vertices = this.m_vertices;

...
namespace InControl
{
	...
	{
		// Token: 0x06002B21 RID: 11041 RVA: 0x000D093C File Offset: 0x000CEB3C
		public NVidiaShield2017AndroidProfile()
		{
			...
			this.JoystickNames = new string[] { "NVIDIA Controller v01.04" };
			this.JoystickRegex = new string[] { "NVIDIA Controller v" };

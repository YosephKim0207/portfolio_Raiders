...
namespace InControl
{
	...
	{
		// Token: 0x06002AE6 RID: 10982 RVA: 0x000C54EC File Offset: 0x000C36EC
		public EightBitdoNES30ProMacProfile()
		{
			...
			this.JoystickNames = new string[] { "Unknown 8Bitdo NES30 Pro", "8Bitdo NES30 Pro   8Bitdo NES30 Pro" };

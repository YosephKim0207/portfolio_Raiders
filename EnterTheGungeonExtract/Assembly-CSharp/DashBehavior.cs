...
{
	// Token: 0x060046EB RID: 18155 RVA: 0x00172188 File Offset: 0x00170388
	...
	// Token: 0x060046EC RID: 18156 RVA: 0x00172264 File Offset: 0x00170464
	...
	// Token: 0x060046ED RID: 18157 RVA: 0x0017227C File Offset: 0x0017047C
	public override BehaviorResult Update()
	{
		...
		{
			this.State = DashBehavior.DashState.Charge;
		}
		else
		{
	...
	// Token: 0x060046EE RID: 18158 RVA: 0x0017231C File Offset: 0x0017051C
	...
	// Token: 0x060046EF RID: 18159 RVA: 0x00172434 File Offset: 0x00170634
	...
	// Token: 0x060046F0 RID: 18160 RVA: 0x001724F4 File Offset: 0x001706F4
	...
	// Token: 0x060046F1 RID: 18161 RVA: 0x00172530 File Offset: 0x00170730
	public void OnCollision(CollisionData collisionData)
	{
		if (this.m_state == DashBehavior.DashState.Dash)
		{
	...
	// Token: 0x060046F2 RID: 18162 RVA: 0x00172584 File Offset: 0x00170784
	...
	// Token: 0x060046F3 RID: 18163 RVA: 0x00172828 File Offset: 0x00170A28
	private Vector2 GetDashDirection()
	{
		...
		for (int i = 0; i < directions.Length; i++)
		{
			bool flag = false;
			bool flag2 = false;
			Vector2 vector2 = BraveMathCollege.DegreesToVector(directions[i], 1f);
			RaycastResult raycastResult;
			bool flag3 = PhysicsEngine.Instance.Raycast(unitCenter, vector2, this.dashDistance, out raycastResult, true, true, int.MaxValue, new CollisionLayer?(CollisionLayer.EnemyCollider), false, null, this.m_aiActor.specRigidbody);
			...
			if (this.avoidTarget && this.m_behaviorSpeculator.TargetRigidbody && !flag && !flag2 && !flag3)
			{
				...
				Vector2 vector4 = this.m_behaviorSpeculator.TargetRigidbody.GetUnitCenter(ColliderType.HitBox) - unitCenter2;
	...
	// Token: 0x060046F4 RID: 18164 RVA: 0x00172BAC File Offset: 0x00170DAC
	private void Fire()
	{
	...
	// (get) Token: 0x060046F5 RID: 18165 RVA: 0x00172C14 File Offset: 0x00170E14
	// (set) Token: 0x060046F6 RID: 18166 RVA: 0x00172C1C File Offset: 0x00170E1C
	...
	// Token: 0x060046F7 RID: 18167 RVA: 0x00172C4C File Offset: 0x00170E4C
	private void BeginState(DashBehavior.DashState state)
	{
		if (state == DashBehavior.DashState.Charge)
		{
		...
		else if (state == DashBehavior.DashState.Dash)
		{
			if (this.bulletScript != null && !this.bulletScript.IsNull)
			{
			...
			if (!string.IsNullOrEmpty(this.dashAnim))
			{
				if (this.warpDashAnimLength)
				{
					...
					string text = this.dashAnim;
					bool flag = true;
					float num = this.dashTime;
					aiAnimator.PlayUntilFinished(text, flag, null, num, false);
				}
				else
				{
			...
			float num2 = this.dashDistance / this.dashTime;
			this.m_dashTimer = this.dashTime;
			this.m_aiActor.ClearPath();
			this.m_aiActor.BehaviorOverridesVelocity = true;
			this.m_aiActor.BehaviorVelocity = num2 * this.m_dashDirection;
	...
	// Token: 0x060046F8 RID: 18168 RVA: 0x00172F00 File Offset: 0x00171100

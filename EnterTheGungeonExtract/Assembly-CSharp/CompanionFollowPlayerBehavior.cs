...
{
	// Token: 0x06004B5C RID: 19292 RVA: 0x001983CC File Offset: 0x001965CC
	...
	// Token: 0x06004B5D RID: 19293 RVA: 0x001983E8 File Offset: 0x001965E8
	...
	// Token: 0x06004B5E RID: 19294 RVA: 0x00198400 File Offset: 0x00196600
	...
	// Token: 0x06004B5F RID: 19295 RVA: 0x0019851C File Offset: 0x0019671C
	...
	// Token: 0x06004B60 RID: 19296 RVA: 0x00198590 File Offset: 0x00196790
	...
	// Token: 0x06004B61 RID: 19297 RVA: 0x001985C8 File Offset: 0x001967C8
		...
		if (this.m_repathTimer <= 0f && !playerController.IsOverPitAtAll && !playerController.IsInMinecart)
		{
			...
			else if (this.m_aiActor.Path != null && !this.m_aiActor.Path.WillReachFinalGoal)
			{
				...
				if (!flag2)
				{
					...
					IntVector2 intVector3 = this.m_aiActor.CompanionOwner.CenterPosition.ToIntVector2(VectorConversions.Floor);
					CellData cellData2 = GameManager.Instance.Dungeon.data[intVector3];
